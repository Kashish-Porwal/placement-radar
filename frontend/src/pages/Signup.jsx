    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0e17] px-4 relative overflow-hidden">
      ...
      <div className="glass p-8 md:p-12 rounded-3xl border border-white/5 w-full max-w-md relative z-10">
        <div className="flex justify-center mb-8">
          <div className="w-14 h-14 bg-gradient-to-tr from-primary to-purple-500 rounded-2xl flex items-center justify-center shadow-[0_0_30px_rgba(6,182,212,0.3)]">
            <Target className="text-white" size={28} />
          </div>
        </div>

        <h1 className="text-2xl font-bold text-center text-white mb-2">Create Account</h1>
        <p className="text-gray-400 text-center mb-8 text-sm">Join Placement Radar today</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            type="submit" 
            disabled={isLoading}
            className="w-full py-3.5 bg-gradient-to-r from-primary to-purple-500 rounded-xl font-medium text-white flex justify-center items-center gap-2 hover:shadow-[0_0_20px_rgba(168,85,247,0.4)] transition-all mt-6 disabled:opacity-70"
          >
        ...
        <p className="text-center text-gray-400 mt-8 text-sm">
          ...
          <Link to="/login" className="text-primary-cyan font-medium hover:underline">
            Sign in
          </Link>
        </p>
      </div>
